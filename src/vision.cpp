...
ContourCorners getContourCorners(std::vector<cv::Point>& contour) {
	...
	std::cout << "DEBUG: Launching approxPolyDP" << std::endl;
	while (true) {
		...
		std::cout << "DEBUG: FittingError=" << fittingError << std::endl;
		std::cout << "DEBUG: Size=" << approx.size() << std::endl;
		std::cout << "DEBUG: FittingStep=" << fittingStep << std::endl;
	}
	std::cout << "DEBUG: Initial Success" << std::endl;
	...
	std::cout << "DEBUG: Refinment Success" << std::endl;
